...
curl https://sourceforge.net/p/latex-macros-packages/env-highlight-brokenpage/ci/master/tree/env-highlight-brokenpage.sty?format=raw -o env-highlight-brokenpage.sty
...
curl https://sourceforge.net/p/latex-macros-packages/env-highlight-tornoff/ci/master/tree/env-highlight-tornoff.sty?format=raw -o env-highlight-tornoff.sty

curl https://sourceforge.net/p/latex-macros-packages/env-highlight-simplenote/ci/master/tree/env-highlight-simplenote.sty?format=raw -o env-highlight-simplenote.sty
